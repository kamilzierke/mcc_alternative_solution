...
static constexpr uint8_t ADDR_INA219_HISTORICAL_0X45 = 0x45;  // Historical/unconfirmed trace. Current native model uses U34 as an HC4067 shunt mux, not an INA219.
